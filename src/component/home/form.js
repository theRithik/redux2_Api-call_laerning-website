...
const url="http://localhost:2001/form"
...
render(){
    ...
    return(     
           <>
           <div id='form'>
           <h3 style={{marginTop:'40px', textAlign:'center'}}>Fill the form to get the details  about the <em style={{color:'red'}}> course</em></h3>
           <form class="row g-3 form" style={{ margin:"60px"}}>
           <div class="col-md-6">
